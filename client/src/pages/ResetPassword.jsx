  ...
  <>
    <div className="flex flex-col justify-center md:flex-row h-screen">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center bg-white p-8 relative">
             <Link
             to={"/password/forgot"}
             className="border-2 border-black rounded-3xl font-bold w-52 py-2 px-4 fixed top-10 left-28 hover:text-white transition duration-300 text-end hover:bg-black"
              >
             Back
            </Link>
            <div className="w-full max-w-sm">
              <div className="flex justify-center mb-12">
                 <div className="rounded-full flex items-center justify-center">
                    <img  src={ruet_logo} alt="logo" className="h-24 w-auto"/>
                 </div>
              </div>
