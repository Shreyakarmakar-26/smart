  ...
  <div className="flex flex-col justify-center md:flex-row h-screen">
   {/*left side*/}
    ...
    bg-white p-8 relative">
      <Link to = {"/register"} className="border-2 border-black rounded-3xl
      font-bold w-52 py-2 px-4 fixed top-10 -left-28 hover:bg-black hover:text-white
      transition duration-300 text-end">
      Back
      </Link>
   ...
   md:flex flex-col items-center justify-center p-8 rounded-tl-[80px] rounded-bl-[80px]">
    <div className="text-center h-[400px]">
      ...
      <p className="text-gray-300 mb-12">If you have no account, please sign up.</p>
