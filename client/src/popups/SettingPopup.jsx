...
const SettingPopup = () => {
 ...
 useEffect(() => {
  if (passwordUpdated) {
    // Reset the auth state after a short delay to clean up
  ...
  return (
   <div className="fixed inset-0 bg-black bg-opacity-50 
    ...
    {passwordUpdated && (
        <div className="fixed top-4 right-4 bg-green-500 text-white px-4 py-2 rounded shadow-lg z-50 flex items-center">
