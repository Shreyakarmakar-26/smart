...
export function generateForgotPasswordEmailTemplate(resetPasswordUrl){
   return `<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 8px; background-color: #f8f8f8; color: #333;">
  <h2 style="color: #fff; text-align: center; background-color: #000;">Reset Your Password</h2>
  ...
  <footer style="margin-top: 20px; text-align: center; font-size: 14px; color: #666;">
    <p>Thank you, <span style="font-weight: bold;">RUET CENTRAL LIBRARY</span></p>
    <p style="font-size: 12px; color: #444;">This is an automated message. Please do not reply to this email.</p>
  </footer>
</div>`
